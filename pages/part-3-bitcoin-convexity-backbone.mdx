...
<Callout type="success" title="Case Study: Multi-Cycle Survivability vs Single-Cycle Exposure">
...
<Callout type="success" title="Model Convergence in Practice: Bitcoin Conviction Assessment">
...
<Callout type="success" title="TAM Math: Conservative Coexistence Scenario">
