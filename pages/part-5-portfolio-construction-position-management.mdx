...
- **Part 5:** Portfolio Construction & Position Management *(this document)*  
...
{/* CROSS-REFERENCE (approved decision 1): the canonical wrapper/tax-comparison exhibit is
    P4-03 "The Tax Wedge" in Part 4. This illustrative example duplicates that comparison; in a
    later slice it should be trimmed to reference the Part 4 exhibit rather than restate it.
    Spec: /chart-specs/SIGNATURE_CHART_SPECS_SLICE_1.md. Part 5 prose otherwise unchanged this slice. */}
