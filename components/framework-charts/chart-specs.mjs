...
export const FRAMEWORK_CHART_SPECS = [
...

  {
    ...
    rangeSteps: {
      ...
      columns: [
        ...
        { id: 'st6', label: 'Stage 6', sub: 'Platform quality', capNote: 'durability · scarcity · optionality', steps: [{ id: 's6', from: 16.4, to: 20, tier: 'primary' }] },
      ],
      rules: [],
    },
    primaryKey: 's6',
...

  {
    ...
    rangeSteps: {
      ...
      columns: [
        ...
        { id: 'hype', label: 'Hype', sub: 'disciplined speculation', capNote: 'CIS ≥50 · aggregate ≤10% · stops 15–25%', cap: { id: 'cap-hype', v: 5, label: 'hard max 5%' }, steps: [
    ...
    hoverTargets: [
      ...
      { id: 'h-band', kind: 'node', label: 'Hype band', name: 'Hype · 2–5% · 10% aggregate', why: 'Eligible from a CIS of fifty, sized two-to-five percent. Momentum is the thesis and the exit signal, so Hype never earns load-bearing size: five percent hard per-position max, ten percent aggregate, stops at fifteen to twenty-five percent.', claim: 'Hype is capped because it has no floor.', concept: 'Hype', link: '/part-5-portfolio-construction-position-management' },
      { id: 'cap-torque', kind: 'node', label: 'Torque ceiling', name: 'Torque ceiling · 15%, override to 18%', why: 'No Torque position exceeds fifteen percent without a documented override — and the live engine only opens the override path to eighteen for positions scoring eighty or above. This is the only posture whose ceiling approaches the portfolio outer bound.', claim: 'Torque\u2019s ceiling is the tallest — and still a ceiling.', concept: 'Concentration limits', link: '/part-5-portfolio-construction-position-management' },
      ...
      { id: 'outer18', kind: 'node', label: 'Outer bound', name: 'Portfolio outer bound · 18% absolute', why: 'The absolute single-position limit at the portfolio level, reachable only through Torque\u2019s documented-override path (live gate: CIS eighty or above). It is not an operative sizing ceiling for Ballast or Hype — their posture ceilings bind first.', claim: 'The outer bound backstops; posture ceilings govern.', concept: 'Concentration limits', link: '/part-5-portfolio-construction-position-management' },
    ],
...

  {
    ...
    claimStack: {
      ...
      caution: 'Conceptual diagnosis matrix; the boundary is the shared live band line — 70 and above is the compliant band on both scores',
    },
    status: 'implemented', wiredPublic: true,
    ...
    sources: [
      ...
      { provider: 'ACF Dashboard · cisBands.js', label: 'The shared four-band register — 70 is the compliance line on both scores', role: 'verifies-concept' },
    ],
