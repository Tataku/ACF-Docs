...
export const FRAMEWORK_CHART_SPECS = [
...

  {
    ...
    hoverTargets: [
      ...
      { id: 'cap-torque', kind: 'node', label: 'Torque ceiling', name: 'Torque ceiling · 15%, override to 18%', why: 'No Torque position exceeds fifteen percent without a documented override, and no override extends beyond eighteen. This is the only posture whose ceiling approaches the portfolio outer bound.', claim: 'Torque\u2019s ceiling is the tallest — and still a ceiling.', concept: 'Concentration limits', link: '/part-5-portfolio-construction-position-management' },
