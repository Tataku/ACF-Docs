...
export const LAYOUT_RELATIONSHIPS = {
  ...
  systemLoop: ['flow'], governanceLoop: ['flow'], feedbackLoop: ['flow'], signature: ['flow'],
};
...
export function resolveVisualRelationship(spec) {
  ...
  if (['loop', 'flow', 'systemLoop', 'governanceLoop', 'feedbackLoop', 'signature', 'bridge', 'gate'].includes(L)) return 'flow';
